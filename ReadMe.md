[text](<Backend Developer (Intern) – Assignment.md>)# **📌 Backend Developer (Intern) – Project Assignment**
...
log files to **saami@bajarangs.com and [nagasai@bajarangs.com](mailto:nagasai@bajarangs.com) & [chetan@bajarangs.com](mailto:chetan@bajarangs.com) CC to sonika@primetrade.ai** with the subject:Frontend Developer Task
